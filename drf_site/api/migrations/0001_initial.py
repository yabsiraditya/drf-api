    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Confirmation', 'Confirmation'), ('Cancelled', 'Cancelled')], default='Pending', max_length=20)),
        ...
        migrations.AddField(
            model_name='order',
            name='items_order',
            field=models.ManyToManyField(related_name='Purchases', through='api.Purchase', to='api.product'),
        ),
    ]
